...
import { Injectable, EventEmitter, Directive, Input, Output, forwardRef, Component, ViewChild, NgModule } from '@angular/core';
...
class BaseReCaptchaComponentDirective {
    ...
    ngAfterViewInit() {
        var _a;
        this.control = (_a = this.injector.get(NgControl, undefined, { optional: true })) === null || _a === void 0 ? void 0 : _a.control;
    }
    ngAfterViewChecked() {
